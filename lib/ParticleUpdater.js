...
class ParticleUpdater {
  ...
  componentUpdater (component) {
    ...
    const prevDOMTree = createParticleElementMark(buffer.DOMTree, buffer.mark)
    const curDOMTree = createParticleElementMark(DOMTree, buffer.mark)

    ParticleElementUpdater.updater(prevDOMTree, curDOMTree, node)
